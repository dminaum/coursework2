...
def test_vacancy_comparison_eq():
    vacancy1 = Vacancy(
        "Developer A", 80000, 100000, "http://example.com/a", "Some skills"
    )
    vacancy2 = Vacancy(
        "Developer B", 80000, 120000, "http://example.com/b", "Other skills"
    )
...
def test_vacancy_repr():
    vacancy = Vacancy(
        "Developer", 90000, 120000, "http://example.com", "Skills required"
    )
    expected_repr = (
        "Vacancy(name=Developer, salary_from=90000,"
        "salary_to=120000, url=http://example.com, requirement=Skills required)"
    )
